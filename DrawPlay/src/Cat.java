...
public class Cat {
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		g2.fillOval(x, y+10, HEAD_DIMENSION, HEAD_DIMENSION);
		// Draw the eyes
		g2.setColor(Color.blue);
		x = catX + EYE_X; 
		y = catY + EYE_Y;
		g2.fillOval(x, y+10, EYE_WIDTH, EYE_HEIGHT);
		x += EYE_SEPARATION;
		g2.fillOval(x, y, EYE_WIDTH, EYE_HEIGHT);
		//Draw nose
		g2.setColor(Color.orange);
		g2.fillOval(x-10, y+25, 10, 10);
		// Draw the mouth
		g2.setColor(Color.pink);
		x = catX + MOUTH_X;
		y = catY + MOUTH_Y;
		g2.fillOval(x, y+10, MOUTH_WIDTH, MOUTH_HEIGHT);
		g2.setColor(Color.black);
		// Meow text appears below cat head, +10 places below 
		// so it doesn't overlap the drawing
		g2.drawString("Purr, Meow.", catX, catY+HEAD_DIMENSION+50);	
	}
}
